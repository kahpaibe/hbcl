# Type hinting
from typing import Dict, List, Tuple, Union, Optional, TypeAlias
...
DeductionTuple: TypeAlias = Tuple[str, Optional[int]]
DEDUCTIONS: Dict[str, Union[Dict[str, DeductionTuple], DeductionTuple]] = {
    'Read mode': {
